 ...
 *
 * 3- Sept-86 - robin
 *	Added unit flag bit to indicate if the drive unit has caching
 *
 * 31-July-86 - robin
 *	Made changes to the tape format flag to reflect a change to
 *	tmscp which will allow tape density to be defined by media type.
 *
 * 11-Jun-86 - bjg
 *	Moved mslg structure to errlog.h for tmscp error logging
 *
 * 18-Oct-85 - afd
 ...
 * Unit flags
 */
#define M_UF_CACH	0100000		/* Set if caching is there */
 ...
 */
#define M_TF_MASK	0377	/* Bitfield mask */
#define M_TF_CODE	0400	/* Format Code multiplier */
#define M_TF_NOR	000	/* Normal (low) Density */
...
#define M_TF_T82	020	/* TU82 special high density */
#define M_TF_BHD	002	/* High Density */

#define M_TC_KLUDGE	0000	/* Current kludge value (Backwards compatible)*/
#define M_TC_9TR	0400	/* New 9 track devices */
#define M_TC_TK50	01000	/* TK50 compatible cartridges */
#define M_TC_RV80	02000	/* RV80 compatible cartridges */
