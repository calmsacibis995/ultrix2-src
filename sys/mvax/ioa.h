...
/*	@(#)ioa.h	1.2	(ULTRIX)	2/11/85 */

/* ------------------------------------------------------------------------
 * Modification History: /sys/vax/ioa.h  IO adapters for VENUS and futures
 *
 * 12-Mar-85 -tresvik
 *	Reduced NIOA8600 from 4 to 2
 *
 * 27-Feb-85 -tresvik
...
#define	IOA8800(i)	((short *)(0x20080000+IOASIZE*i*2))
