...
#ifndef lint
static char *sccsid = "@(#)mt.c	1.28	ULTRIX	3/3/87";
#endif lint
	...
	int flag;
{
	...
	static mtops[] = { MT_WTM, MT_SFORWF, MT_SREVF, MT_SFORW,
