#ifndef MSCP_INCLUDE
#define MSCP_INCLUDE 1
/*
 *	@(#)mscp.h	1.8	(ULTRIX)	6/10/86
...
/************************************************************************
 *
 * Modification history: /sys/vax/mscp.h
 *
 *  3 Jan 84 --jmcg
 *	RQDX1 map register base added.
 *
 *  5 Feb 85 --darrell
 *	Event Sub-codes added.
 *
 * 10 Jun 86 -- map
 *	Allow to be multiply included.
 *	Add defines for various GTUNT end message fields.
 *
 ************************************************************************/
...
#define		Mscp_ctrtmo	Mscp_hsttmo
...
#define mscp_ctrtmo	mscp_un.mscp_setcntchar.Mscp_ctrtmo
