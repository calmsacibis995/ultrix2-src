 ...
 *
 * 10-jun-86 - Tim Burke
 *	Added SYSVDISC which is used to specify System V line discipline. 
 *
 * 30-Jun-86 - Tim Burke
...
#define L001000 	(int)0x2000000
#define CRTKIL		(int)0x4000000	/* Kill line with " \b "	*/
#define L004000 	(int)0x8000000
...
#define SYSVDISC	0x06		/* System V line discipline	*/
