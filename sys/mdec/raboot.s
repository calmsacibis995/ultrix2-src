/*
 * static	char	*sccsid = "@(#)raboot.s	1.4	(ULTRIX)	6/28/85"; 
 */
 ...
 *
 * 28-May-85 -parenti
 *	Save boot device CSR in r9 on exit.
 *	Pass boot unit number in high order r10
 *
 * 01-May-85 -tresvik
 *	Changed PROGSIZE to represent 15 blocks instead of 14.  This
 *	causes the boot image to be truncated when clearing memory.
 *
 */
