...
#include "../vaxuba/sgioctl.h"	/* ioctl call values */
#include "../h/tty.h"
...
#include "../vaxuba/sguser.h"	/* definitions shared with my client */
#include "../vaxuba/sgreg.h"	/* VAXstar(color)  device register structures */
