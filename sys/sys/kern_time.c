#ifndef lint
static char *sccsid = "@(#)kern_time.c	1.8	ULTRIX	10/3/86";
#endif
...
#define RELEASE ""
	...
	if (suser()) {
		...
		bcopy((caddr_t)&time, (caddr_t)&elp->el_body.eltimchg.timchg_time, sizeof(struct timeval));
		bcopy((caddr_t)&tz, (caddr_t)&elp->el_body.eltimchg.timchg_tz, sizeof(struct timezone));
