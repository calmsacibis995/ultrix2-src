#ifndef lint
static char *sccsid = "@(#)if_hy.c	1.9	ULTRIX	10/3/86";
#endif lint
...
#include "hy.h"
#if NHY > 0 || defined(BINARY)

#include "../data/if_hy_data.c"
	...
	int unit, uban;
{
	...
	if (unit >= nNHY || (ui = hyinfo[unit]) == 0 || ui->ui_alive == 0 ||
	  ui->ui_ubanum != uban)
		return;
	printf(" hy%d", unit);
