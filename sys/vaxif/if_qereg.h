 ...
 *
 *  12 Mar 87 -- lp
 *	Put QE_ERROR definition back to 0x4000 
 *  03 Mar 87 -- lp
 *	Modify what an QE_ERROR is. Added QE_TERROR as a xmit error.
 *
 *  13 Feb. 84 -- rjl
 *
...
/* map register defs */
#define QBNOTUB  512			/* first Qbus reg. not on UNIBUS */
#define NQMAPS 7000			/* Number of Qbus regesters */
struct qmap_regs {
	struct pte qb_regs[NQMAPS];
};
struct qmap_regs *qmap;
