 ...
 * between the yellowpages clients and the yellowpages servers.
 * The servers are the yp database servers, and the yp binders.  
 */

/*
 * The following procedures are supported by the protocol:
 * 
 * YPPROC_NULL() returns () takes nothing, returns nothing.
 * This indicates that the yp server is alive.
 * 
