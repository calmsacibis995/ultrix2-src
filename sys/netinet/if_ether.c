#ifndef lint
static char *sccsid = "@(#)if_ether.c	1.8	ULTRIX	1/9/87";
#endif lint
...
#define	ARPTAB_BSIZ	15		/* bucket size */
#define	ARPTAB_NB	29		/* number of buckets */
...
#define	ARPT_KILLC	5	/* kill completed entry in 5 mins. */
...
{
	register n;
	int oldest = -1;  /* was 0 wrongo! borman */
