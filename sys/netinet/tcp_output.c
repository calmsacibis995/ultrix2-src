#ifndef lint
static	char	*sccsid = "@(#)tcp_output.c	1.8	(ULTRIX)	1/29/87";
#endif lint
 ...
 *		Send packets immediately if TCP_NODELAY option is set
 *
...
again:
	 ...
	 * to send into a small window), then must resend.
 	 * If transmitting via local loopback and dst is the same as 
	 * the local host then transmit imediately.
	 */
