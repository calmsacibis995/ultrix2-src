 ...
 *	Created this header file for the VAXstar TZK50 driver.
 *
 **********************************************************************/
...
#define streverseop(cmd) ((cmd)==TM_SREV || (cmd)==TM_REW) /* Reverse	*/
#define TMUNIT(dev)	(sttotm[UNIT(dev)]) /* Controller slave no.	*/
