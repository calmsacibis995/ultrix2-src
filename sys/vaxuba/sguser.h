 ...
 *	Moved color_cursor structure from sgreg.h to this file.
 *
 * 07-Jan-87  -- rafiey (Ali Rafieymehr)
 *	Modified some of the constants used for cursor.
 *
 * 18-Jun-86  -- rafiey (Ali Rafieymehr)
 *	Created this header file for the VAXstar color driver.
 *	Derived from qduser.h.
 *
 **********************************************************************/
...
#define CURS_MIN_X 	88	/* device coordinate x = 0 */
#define CURS_MIN_Y 	38	/* device coordinate y = 0 */
