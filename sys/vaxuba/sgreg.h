 ...
 *	Corrected entry in the vdac structure (hardware document was
 *	 wrong). Also moved the color_cursor structure to sguser.h.
 *
 * 13-Dec-86  -- rafiey (Ali Rafieymehr)
 *	Extensive changes for semi-working VAXstar color driver.
 *
