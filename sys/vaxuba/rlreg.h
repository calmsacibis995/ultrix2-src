...
#define RLMP_STA	0x01		/* Drive state: load cartridge	*/
#define RLMP_STB	0x02		/* Drive state: brush cycle	*/
#define RLMP_STC	0x04		/* Drive state: seek		*/
