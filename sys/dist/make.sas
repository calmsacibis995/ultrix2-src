...
#		[vmb.exe] is need only for 11/750 and 8200/8300 kits
...
# standalone images
#
VMUNIX.GEN=${MASTERROOT}/usr/sys/SAS.gen/vmunix
VMUNIX.RX01=${MASTERROOT}/usr/sys/SAS.rx01/vmunix
VMUNIX.TU58=${MASTERROOT}/usr/sys/SAS.tu58/vmunix
...
#
#
COMPRESS=${DISTROOT}/sys/dist/compress
...
#		vmunix	(uncompressed)
#
TK50.1A TK50.1B: ${LOADER} vmunix.gen descriptor.gen
	...
	cp ${LOADER} TK50.1A
	cat /tmp/sas.descriptor vmunix.gen > TK50.1B
...
#		vmunix	(compressed)
#
RX50.1 RX50.2: ${LOADER} vmunix.gen.C descriptor.gen
	...
	echo "80000008?W 1" >> /tmp/sas.adb.cmd
	adb -w /tmp/sas.descriptor < /tmp/sas.adb.cmd 
	cat ${LOADER} /tmp/sas.descriptor vmb.exe vmunix.gen.C > image
...
#		vmunix	(compressed)
#
RX01.1 RX01.2: ${LOADER} vmunix.rx01.C descriptor.rx01
...
#		vmunix	(compressed)
#
TU58.1 TU58.2: ${LOADER} vmb.exe vmunix.tu58.C descriptor.tu58
