 ...
 *
 *	Stephen Reilly,	10-Dec-84
 * 001- Add new filed in devsw so that we can tell the difference between
 *	disk and tape.
 *
 *	saio.h	6.2	9/23/83	
 ***********************************************************************/
...
struct	iob {
	...
	struct	gnode i_ino;	/* gnode, if file */
