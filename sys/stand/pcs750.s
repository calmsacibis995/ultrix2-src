...
/*	@(#)pcs750.s	1.2 (tresvik; ULTRIX-32 V1.0) 11/3/84 */

/* ------------------------------------------------------------------------
 * Modification History: /sys/stand/pcs750.s
 *
 * 10 Jan 84 --tresvik
 *	Derived from VMS sources: PCSUTL.MAR
 *
 * ------------------------------------------------------------------------
 */


/* Support routines for loading VAX 11/750 Patchable Control Store */

#define PCS_BITCNT	0x2000
					/* Number of patchbits */
#define PCS_MICRONUM 	0x400
					/* Number of Microcode locations */
#define PCS_PATCHADDR	0xf00000
					/* Beginning addr of patchbits */
#define PCS_PCSADDR	0x8000
					/* offset to pcs */
#define PCS_PATCHBIT	0xc000
					/* offset to patchbits register */
#define PCS_ENABLE	0xfff00000
					/* enable pcs */
