 ...
 * 003- Change the symbol MVAXI to GFLOAT to reflect the meaning of the
 *	code
 *	Stephen Reilly, 04-Apr-84
 * 002- Change the symbol MicroVAX to MVAXI
 *
 *	Stephen Reilly, 04-Oct-83:
 * 001 - Added code to handle gfloat conversions for MicroVax
 *
 ************************************************************************/

/*	The range is a limit for the exponent of the converted number
 *	SLR001
*/
#ifdef GFLOAT
...
two31:	.word	0x4200		# slr001 2**31 in gfloat

# else

two31:	.word	0x5000		# 2 ** 31 or double
...
ex5:	addl2	r6,r5		# Add given exponent to calculated exponent
	cmpl	r5,$-range	# slr001 Absurdly small?
	jgtr	ex6		#   ... no
	movl	$-range,r5	# slr001  ... yes, force within limit
ex6:	cmpl	r5,$range	# slr001 Absurdly large?
	jlss	ex7		#   ... no
	movl	$range,r5	# slr001  ... yes, force within bounds
ex7:
/*
...
#ifdef	GFLOAT
	cvtlg	r0,r6		# slr001 low-order part in r6-r7
	cvtlg	r1,r0		# slr001 high-order part in r0-r1
#else
 ...
 */
	...
	mulg2	two31,r0	# slr001 multiply
	addg2	r6,r0		# slr001 combine
#else
...
#ifdef	GFLOAT
	mnegg	r0,r0		# slr001 If negative, make it so
#else
	mnegd	r0,r0		# slr001 If negative, make it so
#endif
...
#ifdef	GFLOAT
	movg	r0,-(sp)	# slr001    and also mantissa
#else
	movd	r0,-(sp)	# slr001   and also mantissa
#endif
