#ifndef lint
static char *sccsid = "@(#)ypv1_xdr.c	1.2	ULTRIX	10/3/86";
#endif lint
 ...
 * administrative tools to support the previous version of the yp
 * protocol.
 * Note that many "old" xdr functions are called, with the assumption
 * that they have not changed between the v1 protocol (which this
 * module exists to support) and the current v2 protocol.  
 */
