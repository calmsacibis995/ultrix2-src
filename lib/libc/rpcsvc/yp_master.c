#ifndef lint
static char *sccsid = "@(#)yp_master.c	1.3	ULTRIX	10/3/86";
#endif lint
 ...
 *   Added a call to "yp_unbind" in the function "yp_master" to release the
	...
	char **master;
{
	...
	/*
	 * Be sure to release the domain binding!
	 */
	yp_unbind(domain);
	return (reason);
}
