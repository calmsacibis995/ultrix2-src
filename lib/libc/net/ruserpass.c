/* SCCSID: @(#)ruserpass.c	1.3	3/26/86 */
 ...
 *
 * 2/21/84 - #ifdef CRYPT added.  This is to remove decryption from
 * the product so that we can ship it overseas. The ramafacations
 * of this is that ruserpass will no longer look in your environment
 * for an encrypted password for remote logins. -Dave Borman
 */
