#ifndef lint
static	char	*sccsid = "@(#)local2.c	1.7	(ULTRIX)	3/16/86";
#endif lint
# include "mfile2"
# include "ctype.h"
...
shumul( p ) register NODE *p; {
	...
	if( ( o == INCR || o == ASG MINUS ) &&
		...
		{		    /*RAP003*/
		switch (p->in.type) /* Used to be p->in.left->in.type*/
			{
			case CHAR|PTR:
			case UCHAR|PTR:
				o = 1;
