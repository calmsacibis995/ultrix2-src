#ifndef lint
static char *sccsid = "@(#)cpp.c	1.8	ULTRIX	1/9/87";
#endif lint
...
doincl(p) register char *p; {
	...
	register char *cp; register char **dirp,*nfil; char filname[BUFSIZ];
...
char *
dodef(p) register char *p; {/* process '#define' */
...
struct symtab *
slookup(p1,p2,enterf) register char *p1,*p2; register int enterf;{
...
char *
subst(p,sp) register char *p; register struct symtab *sp; {
