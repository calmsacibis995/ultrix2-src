#ifndef lint
static char sccsid[] = "@(#)telnetd.c	1.5 (ULTRIX) 9/30/85";
#endif
 ...
 *
 *	5/5/85 -- Larry Cohen
 *		ensure master side of psuedo tty closes first in cleanup()
 *		This need because new vhangup will cause slave to close
 *		before the master and possible resulting in the telnetd
 *		hanging.
 *
 *	4/10/85 -- jrs
