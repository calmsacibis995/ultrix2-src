...
#ifndef lint
static	char	*sccsid = "@(#)icheck.c	1.2	(ULTRIX)	6/11/85";
#endif lint
...
/*								*/
/*	1) - Added named pipe support (re. System V named pipes)*/
/*		15 Mar 85 -- funding				*/
/*								*/
#define	NB	500
#define	MAXFN	500
	...
	char *file;
{
	...
	i = nrfile + ndfile + ncfile + nbfile + nlfile + npfile;/* 1 */
#ifndef STANDALONE
	printf("files %6u (r=%u,d=%u,b=%u,c=%u,sl=%u,p=%u)\n",
		i, nrfile, ndfile, nbfile, ncfile, nlfile, npfile);
#else
	printf("files %u (r=%u,d=%u,b=%u,c=%u,sl=%u,p=%u)\n",
		i, nrfile, ndfile, nbfile, ncfile, nlfile, npfile);
#endif
