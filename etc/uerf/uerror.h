/*  sccsid  =  @(#)uerror.h	1.8   (ULTRIX)   12/16/86  */

/*
*	.TITLE	UERROR - Literal definitions for UERF errors.
*	.IDENT	/1-001/
*
...
#define  UE$ERR_S_OPEN	214	/* Error opening syserr file.		*/
#define  UE$ERR_K_OPEN	215	/* Error opening socket.		*/
...
#define  UE$ERR_CORUPT	402	/* Corrupted error entry.	*/
