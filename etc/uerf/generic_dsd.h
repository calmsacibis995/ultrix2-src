/*  sccsid  =  @(#)generic_dsd.h	1.9   (ULTRIX)   12/16/86  */
/*
...
/* Macro to simulate O/S dependent structure alignment */

#define	ALIGN(offset, bound) offset = \
	(DD$BYTE *)((( (long)offset - 1 + bound) / bound) * bound)
