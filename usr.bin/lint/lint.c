#ifndef lint
static	char	*sccsid = "@(#)lint.c	1.3	(ULTRIX)	3/14/86";
#endif lint
 ...
 *									*
 *	Lu Anne Van de Pas, 13-Mar-86, 2.0				*
 * 002  Added functions cvtfloat and cvtdouble to distinguish between   *
 ...
 * DCON for double constant. lvdp002 
 */ 
