...
# line 108 "/usr/src/lib/mip/cgram.y"
# include "mfile1"
...
# line 127 "/usr/src/lib/mip/cgram.y"
	static int fake = 0;
#ifndef FLEXNAMES
...
# line 840 "/usr/src/lib/mip/cgram.y"
...
case 2:
# line 137 "/usr/src/lib/mip/cgram.y"
ftnend(); break;
case 3:
# line 140 "/usr/src/lib/mip/cgram.y"
{ curclass = SNULL;  blevel = 0; } break;
case 4:
# line 142 "/usr/src/lib/mip/cgram.y"
{ curclass = SNULL;  blevel = 0; } break;
case 5:
# line 146 "/usr/src/lib/mip/cgram.y"
{  yypvt[-1].nodep->in.op = FREE; } break;
case 6:
# line 148 "/usr/src/lib/mip/cgram.y"
{  yypvt[-2].nodep->in.op = FREE; } break;
case 7:
# line 149 "/usr/src/lib/mip/cgram.y"
{
...
case 8:
# line 155 "/usr/src/lib/mip/cgram.y"
{  
...
case 11:
# line 166 "/usr/src/lib/mip/cgram.y"
{  blevel = 1; } break;
case 13:
# line 171 "/usr/src/lib/mip/cgram.y"
{  bccode();
			    locctr(PROG);
			    } break;
case 14:
# line 177 "/usr/src/lib/mip/cgram.y"
...
case 15:
# line 183 "/usr/src/lib/mip/cgram.y"
...
case 57:
# line 317 "/usr/src/lib/mip/cgram.y"
{  if( !(instruct&INSTRUCT) ) uerror( "field outside of structure" );
			    falloc( stab, yypvt[-0].intval, -1, yypvt[-2].nodep );  /* alignment or hole */
			    yyval.nodep = NIL;
			    } break;
case 58:
# line 322 "/usr/src/lib/mip/cgram.y"
{  yyval.nodep = NIL; } break;
case 59:
# line 327 "/usr/src/lib/mip/cgram.y"
{  umul:
				yyval.nodep = bdty( UNARY MUL, yypvt[-0].nodep, 0 ); } break;
case 60:
# line 330 "/usr/src/lib/mip/cgram.y"
{  uftn:
				yyval.nodep = bdty( UNARY CALL, yypvt[-2].nodep, 0 );  } break;
case 61:
# line 333 "/usr/src/lib/mip/cgram.y"
{  uary:
				yyval.nodep = bdty( LB, yypvt[-2].nodep, 0 );  } break;
case 62:
# line 336 "/usr/src/lib/mip/cgram.y"
{  bary:
				if( (int)yypvt[-1].intval <= 0 ) werror( "zero or negative subscript" );
				yyval.nodep = bdty( LB, yypvt[-3].nodep, yypvt[-1].intval );  } break;
case 63:
# line 340 "/usr/src/lib/mip/cgram.y"
{  yyval.nodep = bdty( NAME, NIL, yypvt[-0].intval );  } break;
case 64:
# line 342 "/usr/src/lib/mip/cgram.y"
{ yyval.nodep=yypvt[-1].nodep; } break;
case 65:
# line 345 "/usr/src/lib/mip/cgram.y"
{  goto umul; } break;
case 66:
# line 347 "/usr/src/lib/mip/cgram.y"
{  goto uftn; } break;
case 67:
# line 349 "/usr/src/lib/mip/cgram.y"
{  goto uary; } break;
case 68:
# line 351 "/usr/src/lib/mip/cgram.y"
{  goto bary; } break;
case 69:
# line 353 "/usr/src/lib/mip/cgram.y"
{ yyval.nodep = yypvt[-1].nodep; } break;
case 70:
# line 355 "/usr/src/lib/mip/cgram.y"
{
...
case 71:
# line 361 "/usr/src/lib/mip/cgram.y"
{
				yyval.nodep = bdty( UNARY CALL, bdty(NAME,NIL,yypvt[-1].intval), 0 );
				stwart = 0;
				} break;
case 72:
# line 368 "/usr/src/lib/mip/cgram.y"
{
...
case 73:
# line 377 "/usr/src/lib/mip/cgram.y"
{ ftnarg( yypvt[-0].intval );  stwart = SEENAME; } break;
case 74:
# line 379 "/usr/src/lib/mip/cgram.y"
{ ftnarg( yypvt[-0].intval );  stwart = SEENAME; } break;
case 77:
# line 385 "/usr/src/lib/mip/cgram.y"
{yyval.nodep=yypvt[-2].nodep;} break;
case 79:
# line 389 "/usr/src/lib/mip/cgram.y"
{  defid( yypvt[-0].nodep = tymerge(yypvt[-1].nodep,yypvt[-0].nodep), curclass);
			    beginit(yypvt[-0].nodep->tn.rval);
			    } break;
case 81:
# line 396 "/usr/src/lib/mip/cgram.y"
{  nidcl( tymerge(yypvt[-1].nodep,yypvt[-0].nodep) ); } break;
case 82:
# line 398 "/usr/src/lib/mip/cgram.y"
{  defid( tymerge(yypvt[-1].nodep,yypvt[-0].nodep), uclass(curclass) );
			} break;
case 83:
# line 402 "/usr/src/lib/mip/cgram.y"
{  doinit( yypvt[-0].nodep );
			    endinit(); } break;
case 84:
# line 405 "/usr/src/lib/mip/cgram.y"
{  endinit(); } break;
case 88:
# line 415 "/usr/src/lib/mip/cgram.y"
{  doinit( yypvt[-0].nodep ); } break;
case 89:
# line 417 "/usr/src/lib/mip/cgram.y"
{  irbrace(); } break;
case 94:
# line 429 "/usr/src/lib/mip/cgram.y"
{  werror( "old-fashioned initialization: use =" ); } break;
case 96:
# line 434 "/usr/src/lib/mip/cgram.y"
{  ilbrace(); } break;
case 99:
# line 444 "/usr/src/lib/mip/cgram.y"
{  
#ifndef LINT
			    prcstab(blevel);
#endif
...
case 100:
# line 458 "/usr/src/lib/mip/cgram.y"
{  --blevel;
			    if( blevel == 1 ) blevel = 0;
			    clearst( blevel );
			    checkst( blevel );
...
case 101:
# line 468 "/usr/src/lib/mip/cgram.y"
{  if( blevel == 1 ) dclargs();
			    ++blevel;
...
case 102:
# line 477 "/usr/src/lib/mip/cgram.y"
{ ecomp( yypvt[-1].nodep ); } break;
case 104:
# line 480 "/usr/src/lib/mip/cgram.y"
{ deflab(yypvt[-1].intval);
			   reached = 1;
			   } break;
case 105:
# line 484 "/usr/src/lib/mip/cgram.y"
...
case 106:
# line 490 "/usr/src/lib/mip/cgram.y"
{  branch(  contlab );
			    deflab( brklab );
...
case 107:
# line 497 "/usr/src/lib/mip/cgram.y"
{  deflab( contlab );
...
case 108:
# line 505 "/usr/src/lib/mip/cgram.y"
{  deflab( contlab );
			    if( flostat&FCONT ) reached = 1;
...
case 109:
# line 515 "/usr/src/lib/mip/cgram.y"
...
case 110:
# line 523 "/usr/src/lib/mip/cgram.y"
...
case 111:
# line 530 "/usr/src/lib/mip/cgram.y"
...
case 112:
# line 536 "/usr/src/lib/mip/cgram.y"
{  retstat |= NRETVAL;
			    branch( retlab );
			rch:
...
case 113:
# line 543 "/usr/src/lib/mip/cgram.y"
{  register NODE *temp;
			    idname = curftn;
...
case 114:
# line 560 "/usr/src/lib/mip/cgram.y"
{  register NODE *q;
...
case 119:
# line 574 "/usr/src/lib/mip/cgram.y"
{  register NODE *q;
...
case 120:
# line 581 "/usr/src/lib/mip/cgram.y"
{  addcase(yypvt[-1].nodep);
			    reached = 1;
			    } break;
case 121:
# line 585 "/usr/src/lib/mip/cgram.y"
{  reached = 1;
			    adddef();
			    flostat |= FDEF;
			    } break;
case 122:
# line 591 "/usr/src/lib/mip/cgram.y"
{  savebc();
...
case 123:
# line 600 "/usr/src/lib/mip/cgram.y"
{  ecomp( buildtree( CBRANCH, yypvt[-1].nodep, bcon( yyval.intval=getlab()) ) ) ;
			    reached = 1;
			    } break;
case 124:
# line 605 "/usr/src/lib/mip/cgram.y"
...
case 125:
# line 613 "/usr/src/lib/mip/cgram.y"
{  savebc();
			    if( !reached ) werror( "loop not entered at top");
...
case 126:
# line 624 "/usr/src/lib/mip/cgram.y"
...
case 127:
# line 636 "/usr/src/lib/mip/cgram.y"
{  savebc();
			    brklab = getlab();
...
case 128:
# line 645 "/usr/src/lib/mip/cgram.y"
{ yyval.intval=instruct; stwart=instruct=0; } break;
case 129:
# line 647 "/usr/src/lib/mip/cgram.y"
{  yyval.intval = icons( yypvt[-0].nodep );  instruct=yypvt[-1].intval; } break;
case 131:
# line 651 "/usr/src/lib/mip/cgram.y"
{ yyval.nodep=0; } break;
case 133:
# line 656 "/usr/src/lib/mip/cgram.y"
{  goto bop; } break;
case 134:
# line 660 "/usr/src/lib/mip/cgram.y"
{
			preconf:
...
case 135:
# line 670 "/usr/src/lib/mip/cgram.y"
{  yypvt[-1].intval = COMOP;
			    goto bop;
			    } break;
case 136:
# line 674 "/usr/src/lib/mip/cgram.y"
{  goto bop; } break;
case 137:
# line 676 "/usr/src/lib/mip/cgram.y"
{  if(yychar==SHIFTOP) goto precplaint; else goto bop; } break;
case 138:
# line 678 "/usr/src/lib/mip/cgram.y"
{  if(yychar==SHIFTOP ) goto precplaint; else goto bop; } break;
case 139:
# line 680 "/usr/src/lib/mip/cgram.y"
{  if(yychar==PLUS||yychar==MINUS) goto precplaint; else goto bop; } break;
case 140:
# line 682 "/usr/src/lib/mip/cgram.y"
{  goto bop; } break;
case 141:
# line 684 "/usr/src/lib/mip/cgram.y"
{  goto preconf; } break;
case 142:
# line 686 "/usr/src/lib/mip/cgram.y"
{  if( yychar==RELOP||yychar==EQUOP ) goto preconf;  else goto bop; } break;
case 143:
# line 688 "/usr/src/lib/mip/cgram.y"
{  if(yychar==RELOP||yychar==EQUOP) goto preconf; else goto bop; } break;
case 144:
# line 690 "/usr/src/lib/mip/cgram.y"
{  if(yychar==RELOP||yychar==EQUOP) goto preconf; else goto bop; } break;
case 145:
# line 692 "/usr/src/lib/mip/cgram.y"
{  goto bop; } break;
case 146:
# line 694 "/usr/src/lib/mip/cgram.y"
{  goto bop; } break;
case 147:
# line 696 "/usr/src/lib/mip/cgram.y"
{  abop:
				yyval.nodep = buildtree( ASG yypvt[-2].intval, yypvt[-3].nodep, yypvt[-0].nodep );
				} break;
case 148:
# line 700 "/usr/src/lib/mip/cgram.y"
{  goto abop; } break;
case 149:
# line 702 "/usr/src/lib/mip/cgram.y"
{  goto abop; } break;
case 150:
# line 704 "/usr/src/lib/mip/cgram.y"
{  goto abop; } break;
case 151:
# line 706 "/usr/src/lib/mip/cgram.y"
{  goto abop; } break;
case 152:
# line 708 "/usr/src/lib/mip/cgram.y"
{  goto abop; } break;
case 153:
# line 710 "/usr/src/lib/mip/cgram.y"
{  goto abop; } break;
case 154:
# line 712 "/usr/src/lib/mip/cgram.y"
{  goto abop; } break;
case 155:
# line 714 "/usr/src/lib/mip/cgram.y"
{  yyval.nodep=buildtree(QUEST, yypvt[-4].nodep, buildtree( COLON, yypvt[-2].nodep, yypvt[-0].nodep ) );
			    } break;
case 156:
# line 717 "/usr/src/lib/mip/cgram.y"
{  werror( "old-fashioned assignment operator" );  goto bop; } break;
case 157:
# line 719 "/usr/src/lib/mip/cgram.y"
{  goto bop; } break;
case 159:
# line 723 "/usr/src/lib/mip/cgram.y"
{  yyval.nodep = buildtree( yypvt[-0].intval, yypvt[-1].nodep, bcon(1) ); } break;
case 160:
# line 725 "/usr/src/lib/mip/cgram.y"
{ ubop:
			    yyval.nodep = buildtree( UNARY yypvt[-1].intval, yypvt[-0].nodep, NIL );
			    } break;
case 161:
# line 729 "/usr/src/lib/mip/cgram.y"
...
case 162:
# line 736 "/usr/src/lib/mip/cgram.y"
{  goto ubop; } break;
case 163:
# line 738 "/usr/src/lib/mip/cgram.y"
{
			    yyval.nodep = buildtree( yypvt[-1].intval, yypvt[-0].nodep, NIL );
			    } break;
case 164:
# line 742 "/usr/src/lib/mip/cgram.y"
{  yyval.nodep = buildtree( yypvt[-1].intval==INCR ? ASG PLUS : ASG MINUS,
						yypvt[-0].nodep,
						bcon(1)  );
			    } break;
case 165:
# line 747 "/usr/src/lib/mip/cgram.y"
{  yyval.nodep = doszof( yypvt[-0].nodep ); } break;
case 166:
# line 749 "/usr/src/lib/mip/cgram.y"
...
case 172:
# line 771 "/usr/src/lib/mip/cgram.y"
{  idname = yypvt[-0].intval;
...
case 173:
# line 788 "/usr/src/lib/mip/cgram.y"
{  yyval.nodep=bcon(0);
...
case 174:
# line 794 "/usr/src/lib/mip/cgram.y"
{  yyval.nodep=buildtree(FCON,NIL,NIL);
			    yyval.nodep->fpn.dval = dcon;
			    } break;
case 175:
# line 798 "/usr/src/lib/mip/cgram.y"
{  yyval.nodep = getstr(); /* get string contents */ } break;
case 176:
# line 800 "/usr/src/lib/mip/cgram.y"
{ yyval.nodep=yypvt[-1].nodep; } break;
case 177:
# line 804 "/usr/src/lib/mip/cgram.y"
{
...
case 178:
# line 812 "/usr/src/lib/mip/cgram.y"
{ yyval.nodep = bdty( NAME, NIL, -1 ); } break;
case 179:
# line 814 "/usr/src/lib/mip/cgram.y"
{ yyval.nodep = bdty( UNARY CALL, bdty(NAME,NIL,-1),0); } break;
case 180:
# line 816 "/usr/src/lib/mip/cgram.y"
{  yyval.nodep = bdty( UNARY CALL, yypvt[-3].nodep, 0 ); } break;
case 181:
# line 818 "/usr/src/lib/mip/cgram.y"
{  goto umul; } break;
case 182:
# line 820 "/usr/src/lib/mip/cgram.y"
{  goto uary; } break;
case 183:
# line 822 "/usr/src/lib/mip/cgram.y"
{  goto bary;  } break;
case 184:
# line 824 "/usr/src/lib/mip/cgram.y"
{ yyval.nodep = yypvt[-1].nodep; } break;
case 185:
# line 828 "/usr/src/lib/mip/cgram.y"
