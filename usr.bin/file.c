...
#ifndef lint
static char *sccsid = "@(#)file.c	1.14	ULTRIX	10/3/86";
#endif lint
 ...
 * 15-Mar-85 - funding
 *
 *      Added named pipe support (re. System V named pipes). -001
 *
 * 26-Apr-86 - ricky palmer
 *
 *      Added enhanced support for character special files that can
 *      obtain device ioctl information from their respective drivers.
 *      V2.0
 *
 * 30-Jun-86 - marc
 *
 *      For special files if open/readonly fails try open/writeonly.
 *      Most ttys are writeonly.
 *
 */
...
cspcl:
                ...
                printf(" special (%d/%d)", major(mbuf.st_rdev), minor(mbuf.st_rdev));
