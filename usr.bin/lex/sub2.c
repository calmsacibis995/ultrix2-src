#ifndef lint
static	char	*sccsid = "@(#)sub2.c	1.2	(ULTRIX)	9/23/85";
#endif lint
 ...
 *
 *	David Metsky, 26-Aug-1985
 *
 * 001 Changed the condition for making YYTYPE either a char or an int
 *      to >= from >.	
 *
 *	Based on: sub2.c	4.1 (Berkeley) 8/11/83
 *	
 ************************************************************************/
