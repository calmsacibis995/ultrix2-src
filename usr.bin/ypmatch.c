#ifndef lint
static char *sccsid = "@(#)ypmatch.c	1.1	ULTRIX	10/3/86";
#endif lint
 ...
 * will be translated into a mapname according to the translation table
 * at transtable.  The  -t switch inhibits this translation.
 * The -k switch prints keys as well as values.
 * The -x switch may be used alone to dump the translation table.
 */
