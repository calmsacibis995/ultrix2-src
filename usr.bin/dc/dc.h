 ...
 *	1. Stack size is too small, increase to 200 from 100.
 *	2. Error message should be a stderr instead of stdout.
 *	   Bc is a preprocessor for dc. A stderr is need for runnung bc.
 ************************************************************************/
/*	dc.h	1.2	83/03/30	*/
