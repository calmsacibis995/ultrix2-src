...
struct Filed {
	u_char	flags;			/* how open, keep open */
	union {
		int	ufiled;		/* opened by open */
		FILE	*ufilep;		/* opened by fopen */
	} foo;
};

struct Filed files[];

#define KEEP_OPEN	0x10
#define	SYS_OPEN	0x01
#define LIB_OPEN	0x02
#define PIPE_OPEN	0x03
#define	filed	foo.ufiled
#define filep	foo.ufilep
