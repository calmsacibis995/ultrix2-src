#ifndef lint
static	char	*sccsid = "@(#)optim.c	1.3	(ULTRIX)	12/10/84";
#endif lint
 ...
 * optim.c
 *
 *	sccsid[] = "@(#)optim.c	2.9 (Berkeley) 8/11/83";
 *
 *	15-Feb-84	mah. Fixed buffer overflow in netlook routine.
 *
 */
	...
	char machine[];
{
	...
	register char *cp, *cp2;
				/*15-Feb-84 change*/
	char nbuf[250];		/*increase nbuf size to prevent overflow*/
				/*end of change*/
