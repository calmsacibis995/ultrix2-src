...
const_decl:
	YCONST YID '=' const ';'
		= constbeg($1.i_entry), const_setup(lineof($3.i_entry), $2.cptr,
						$4.tr_entry);
		|
	const_decl YID '=' const ';'
		= const_setup(lineof($3.i_entry), $2.cptr, $4.tr_entry);
		|
	YCONST error
		= {
			constbeg($1.i_entry);
