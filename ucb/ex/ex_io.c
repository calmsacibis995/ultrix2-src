...
/* Modifications: 
 *	01	03-Mar-87, Teoman Topcubasi
 *		Checking fsync return codes for file system full condition
 *
 *	02	19-Mar-87, Teoman Topcubasi
 *		Removed one fsync call after writing the buffer.  
 *		SPR SMU-01246 "vi line substitution command output"
 */
#ifndef lint
static char *sccsid = "@(#)ex_io.c	1.5 (Ultrix) 3/19/87";

/*
Original SCCS ID:
	 "@(#)ex_io.c	7.11 (Berkeley) 6/7/85
*/
#endif not lint
