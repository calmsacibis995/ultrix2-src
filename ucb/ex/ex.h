 ...
 *
 *	SCCS Id: @(#)ex.h	1.3 (Ultrix) 10/22/85
 *
 *	Original SCCS ID: ex.h	7.7 (Berkeley) 5/31/85
 *
 Modification History
 ~~~~~~~~~~~~~~~~~~~~
01	22-Oct-85, Greg Tarsa
	Added sigmask macro for changing a signal number into the
	proper sigblock() mask.
*/
