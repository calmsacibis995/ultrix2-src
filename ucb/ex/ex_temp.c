#ifndef lint
static char *sccsid = "@(#)ex_temp.c	1.3	ULTRIX	10/2/86";

/*
Original SCCS ID:
	 "@(#)ex_temp.c	7.5 (Berkeley) 6/7/85
*/
#endif not lint
/*
 ...
 * specifies the terms and conditions for redistribution.
 ...
 ~~~~~~~~~~~~~~~~~~~
01	23-May-85, Greg Tarsa
	Fixed a bug where the last block of an encrypted file was not
	being encrypted on output.  Thanks to John Dustin for this fix.

02	03-Mar-87, Teoman Topcubasi
	Fixed a problem relating to the handling of the output buffer
	in the case of encrypted files.  Thanks John Dustin for this fix.
	See SMU-1081, SMU-1082 for further description.
