 ...
 *	      (vjh, April 29, 1986)					*
 *									*
 *	002 - Pointer types were displayed both in octal and hex.	*
 *            Eliminated this redundancy; now are displayed in hex	*
 *	      only.							*
 *	      (vjh, July 9, 1985)					*
 *									*
 *	001 - Modified pascal_init() to use LanguageName constant in 	*
...
public pascal_init()
{
    pasc = language_define("pascal", PASCAL);
