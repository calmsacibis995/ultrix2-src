#ifndef lint
static char *sccsid = "@(#)errortouch.c	1.2	ULTRIX	10/3/86";
#endif lint
...
*
* 001	David N. Metsky, 07-JUN-1986
*	Made the -n option work correctly, as it looks as though it
*	was set up, but the notouch flag was never checked.
*
*************************************************************************/
#include <stdio.h>
#include <ctype.h>
