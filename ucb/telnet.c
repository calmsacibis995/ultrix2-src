#ifndef lint
static	char	*sccsid = "@(#)telnet.c	1.3	(ULTRIX)	1/15/87 (From 4.24 (Berkeley) 7/20/83)";
#endif lint
...
/*
 *
 * 	14-Jan-87 lp - Added cr mode conversion.
 *
 *	12-Dec-86 lp - Fixed flow control. Reduced 5 second sleep to 1 second.
 *
 */
/*
 * User telnet program.
	...
	char *argv[];
{
	...
	notc.t_startc = otc.t_startc; /* Use default flow control */
