#ifndef lint
static	char	*sccsid = "@(#)eval2.c	1.2	(ULTRIX)	8/16/85";
#endif lint
 ...
 * 001	Change bcopy() to xbcopy() so that it doesn't conflict with the
 *	bcopy() in libc.
 *
 *	Based on:  eval2.c,v 1.6 83/09/12 14:18:02 sklower Exp
 *
 ************************************************************************/
