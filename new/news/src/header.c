# ifndef lint
static char *Sccsid = "@(#)header.c	1.2	12/10/84";
# endif not lint

/*
 * static char *SccsId = "@(#)header.c	1.2 3/8/84 (from 2.20 6/24/83 news 2.10.1)";
 */

/* ------------------------------------------------------------------------
 * Modification History: /usr/src/local/news-2.10.1/src/header.c
 *
 *  7 Mar 84 --jmcg
 *	Article-munching bug fixed.  Fix obtained from Guy Harris via
 *	Mark Horton and Donn Seeley.
 *
 * ------------------------------------------------------------------------
 */
