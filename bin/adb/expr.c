#ifndef lint
static	char	*sccsid = "@(#)expr.c	1.2	(ULTRIX)	9/23/85";
#endif lint
 ...
 *
 *	David L Ballenger, 26-Aug-1985
 * 001	Fix convdig() so that it correctly handles uppercase characters
 *	in hexadecimal numbers.
 *
 *	Based on:  expr.c	4.8 8/11/83
 *
 ************************************************************************/
...
CHAR c;
{
	...
	THEN	return(c-'0');
	ELIF isxdigit(c)
	THEN	return(c - (isupper(c) ? 'A' : 'a') + 10);
	ELSE	return(17);
	FI
}
