#ifndef lint
static	char	*sccsid = "@(#)misc.c	1.1	(ULTRIX)	3/20/86";
#endif lint
...
/* fast version  using movc5 to clear memory */

char *
calloc(num, size)
register unsigned num;	/* r11 */
register unsigned size;	/* r10 */
{
	register char *mp;	/* r9 */
	char *malloc();
	...
	/* use the register knowledge for movc5 */
	asm("	movc5	$0,(r9),$0,r11,(r9)");
	return(mp);
}
