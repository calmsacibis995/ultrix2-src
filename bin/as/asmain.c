#ifndef lint
static	char	*sccsid = "@(#)asmain.c	1.5	(ULTRIX)	9/30/85";
#endif not lint
 ...
 *
 *	David L Ballenger, 25-Mar-1985
 * 003-	Remove error messages for G and H float opcodes, since the
 *	emulation code will be provided on all ULTRIX-32/32m systems.
 *
 *	Stephen Reilly, 14-May-84
 * 002- Base the removal of the g and g float opcodes on the symbol
 *	GFLOAT
 *
 *	Stephen Reilly, 3-Apr-84
 * 001- Remove error messages for g and h float opcodes.
 *
 ***********************************************************************/
