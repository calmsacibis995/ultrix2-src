#ifndef lint
static char *sccsid = "@(#)ypset.c	1.1	ULTRIX	10/3/86";
#endif lint
...
/*
 * This is a user command which issues a "Set domain binding" command
 * to a yellowpages binder (ypbind) process
 *
 *	ypset [-V1] [-h <host>] [-d <domainname>] server_to_use
 *
 * where  host  and  server_to_use  may be either names or
 * internet addresses.
 */
#include <stdio.h>
#include <sys/time.h>
