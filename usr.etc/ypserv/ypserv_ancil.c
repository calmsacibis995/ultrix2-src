#ifndef lint
static char *sccsid = "@(#)ypserv_ancil.c	1.1	ULTRIX	10/3/86";
#endif lint
...
/*
 * This constructs a file name from a passed domain name, a passed map
 * name, and a globally known yellow pages data base path prefix.
 */
void
