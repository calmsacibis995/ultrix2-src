#ifndef lint
static char *sccsid = "@(#)common.c	1.4	ULTRIX	10/3/86";
#endif
...
char	*PP;		/* name of print filter replacement */
char	*XF;		/* name of pass-thru filter */
char	*FF;		/* form feed string */
char	*TR;		/* trailer string to be output when Q empties */
char	*TS;		/* terminal server node name */
char	*OP;		/* object port on terminal server */
char	*OS;		/* object service on terminal server */
