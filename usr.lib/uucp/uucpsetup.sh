#!/bin/sh
#  @(#)uucpsetup.sh	1.6	ULTRIX	12/16/86
#
...
30 * * * * su uucp < $UULIB/uucp.hour
0 6 * * * su uucp < $UULIB/uucp.day
0 12 * * * su uucp < $UULIB/uucp.noon
0 3 1 * * su uucp < $UULIB/uucp.week
0 2 * * * su uucp < $UULIB/uucp.night
#30 2 1 * * su uucp < $UULIB/uucp.longhall
# %UUCPEND%" >> $CRONTAB
	} 
