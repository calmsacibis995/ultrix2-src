/* static char sccsid[] = "@(#)uucp.h	1.7 (decvax!larry) 6/11/85"; */
...
#define EOTMSG "\04\n\04\n"
#define CALLBACK 1
#define DEFAULTPROTO 'g'	/* try to use this proto if possible */
...
struct Devices {
	...
	char D_proto[20];	/* prefered proto to use. e.g. "g", "f" */
};
