#ifndef lint
static char *sccsid = "@(#)ps_img.c	1.1	ULTRIX	10/3/86";
#endif lint
/************************************************************************
 *									*
 *			Copyright (c) 1986 by				*
...
/************************************************************************/
/*									*/
/*	ps_img - image file print filter for PostScript Printer	*/
/*									*/
...
fprintf(stdout,"%%%%Creator: @(#)ps_img.c	1.1\n");
